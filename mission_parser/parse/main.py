...
_demo_services_mission_parser_views_PARSER = MissionParser()


_demo_services_mission_parser_views_LOG = logging.getLogger(__name__)


_demo_services_mission_parser_constants_ALLOWED_EXTENSIONS = {'mis'}


_demo_services_mission_parser_constants_ALLOWED_CONTENT_TYPES = {'application/octet-stream'}
...
@_demo_services_core_cors_with_cors(allow_methods=('POST', 'OPTIONS'))
def parse(request):
    ...
    try:
        ...
        _demo_services_mission_parser_views_LOG.exception("failed to upload mission")
    ...
    try:
        _demo_services_core_validators_validate_upload(
            ...
            _demo_services_mission_parser_constants_ALLOWED_EXTENSIONS,
            _demo_services_mission_parser_constants_ALLOWED_CONTENT_TYPES,
        )
    except ValueError as e:
        _demo_services_mission_parser_views_LOG.error(
    ...
    try:
        ...
        _demo_services_mission_parser_views_LOG.exception(
    ...
    try:
        ...
        data = _demo_services_mission_parser_views_PARSER.parse(stream)
    except Exception:
        _demo_services_mission_parser_views_LOG.exception(
