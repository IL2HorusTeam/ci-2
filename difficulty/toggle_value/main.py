...
from il2fb.config.difficulty import toggle_parameter
...
class _demo_services_core_response_RESTConflict(_demo_services_core_response_RESTBadRequest):
    code = 409
    detail = "Conflict"
...
def toggle_value(request):
    ...
    try:
        ...
        return _demo_services_core_response_RESTConflict()
